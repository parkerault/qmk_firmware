...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    XXXXXXX, WINLOCK, XXXXXXX, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSPC, \
  KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    XXXXXXX, XXXXXXX, XXXXXXX, KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSLS, \
  CTRLESC, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_LCBR, XXXXXXX, KC_RCBR, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, QUO_L5,  \
  KC_LSPO, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_LBRC, XXXXXXX, KC_RBRC, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSPC, \
  KC_CAPS, XXXXXXX, KC_LALT, KC_LGUI, ENT_L1,  EQL_L3,  KC_LPRN, XXXXXXX, KC_RPRN, MIN_L4,  SPC_L2,  KC_MEH,  KC_HYPR, XXXXXXX, KC_DEL   \
  ),
