...
*/
  ...
  CTRLESC, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_HOME, KC_PGUP, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, \
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_LBRC, KC_RBRC, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, \
  KC_CAPS, _______, KC_LALT, KC_LGUI, ENT_L1,  MO(_3),  KC_LPRN, KC_RPRN, MO(_4),  SPC_L2,  MEH_EQL, HPR_MIN, _______, KC_DEL   \
  ),

  [_1] = LAYOUT_ortho_5x14(
  ...
  _______, M_GEN,   M_FUNC,  M_CONST, M_ARROW, M_BLOCK, _______, _______, _______, KC_P4,   KC_P5,   KC_P6,   XXXXXXX, KC_PMNS, \
  _______, _______, _______, M_TRY,   M_CATCH, _______, _______, _______, _______, KC_P1,   KC_P2,   KC_3,    XXXXXXX, KC_PPLS, \
  _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_P0,   KC_COMM, KC_PDOT, XXXXXXX, KC_PENT  \
  ),

  [_2] = LAYOUT_ortho_5x14(
  ...
  DEBUG,   _______, _______, _______, KC_BTN2, KC_BTN1, _______, _______, _______, _______, _______, _______, _______, _______  \
  )
};
/*
